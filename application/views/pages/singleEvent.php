<?php 
if(!empty($event)){
   $event_title= $event['0']['event_title'];
$description= $event['0']['description'];
if(!empty($event['0']['cover_photo'])){
    $cover_photo = base_url().'uploads/event/'.$event['0']['cover_photo'];
}else{
    $cover_photo = base_url().'uploads/initial-images/college.jpg';
}
 $posted_date = $event['0']['posted_date'];
 $cdate = new DateTime($posted_date);
    $y =  $cdate->format("Y");
    $mon =    $cdate->format("M");
    $day =    $cdate->format("d"); 

   $s_time = date("g:i a", strtotime($event['0']['start_time']));
    $e_time = date("g:i a", strtotime($event['0']['end_time']));
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="text-left col-md-8">
                            <h2 class="page-leading">Event Details</h2>
                            <h3 class="page-subleading"><?php echo $event_title;?> </h3> </div>
                    </div>
                </div>
            </div>
            <!--/.sub-title-->
                        ...
                        <div class="wpb_single_image wpb_content_element vc_align_left" style="margin-top: -1px;">
                            ...
                            <div class="vc_column-inner ">
                                <div class="wpb_wrapper" style="padding-bottom: 30px;">
                                    ...
                                    <span class="entry-date-time"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $s_time.' - '.$e_time;?></span>
                                    <div class="themeum-title title-leftborder leftborder">
                                    <h2 class="thm-titlecustomstyle" style="font-size:16px;word-wrap: break-word;color:#000000;font-weight:700;margin:20px 0px 26px 0px;padding:0px;"><?php echo $event_title;?> </h2></div>
                                </div>
