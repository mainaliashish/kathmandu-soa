                ...
                <div class="container">
                    <div class="row">
                        <div class="text-left col-md-8">
                            <h2 class="page-leading">Announcements</h2>
                            <h3 class="page-subleading">KUSOA Announcements</h3> </div>
                    </div>
                </div>
            </div>
            <!--/.sub-title-->
    ...
    $day =    $cdate->format("d");
                        ...
                        echo '<div class="themeum-notice-list"><span class="notice-list-meta-date"><span>'.$day.'</span>'.$mon.', '.$y.'</span>
                                <div class="thm-notice-data">
                                 <h4 class="notice-list-title"><a href="'.base_url().'index.php/Arts/singleannoucement?aid='.$ann['a_id'].'">'.$ann['a_title'].'</a></h4></div>
                                <div class="readmore-wrap"><a href="'.base_url().'index.php/Arts/singleannoucement?aid='.$ann['a_id'].'" class="btn btn-primary">Read More</a></div>
                            </div>';
                        }
                    }else{
                        echo "No Announcements availabel";
                    }
                        ?>        
