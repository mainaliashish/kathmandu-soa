                ...
                <div class="container">
                    <div class="row">
                        <div class="text-left col-md-8">
                            <h2 class="page-leading">Upcomming Events</h2>
                            <h3 class="page-subleading">KUSOA Events</h3> </div>
                    </div>
                </div>
            </div>
            <!--/.sub-title-->
   ...
   $mon =    $cdate->format("M");
    $day =    $cdate->format("d");
                 ...
                 echo '<div class="themeum-notice-list"><span class="notice-list-meta-date"><span>'.$day.'</span>'.$mon.', '.$y.'</span>
                        ...
                        <h4 class="notice-list-title"><a href="'.base_url().'index.php/Arts/singleEvent?eid='.$eve['a_id'].'">'.$eve['event_title'].'</a></h4></div>
                        <div class="readmore-wrap"><a href="'.base_url().'index.php/Arts/singleEvent?eid='.$eve['a_id'].'" class="btn btn-primary">Read More</a></div>
                            </div>';
                        }
                    }else{
                        echo "No Events availabel";
                    }
                        ?>        
