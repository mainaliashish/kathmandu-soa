 <?php
    if(!empty($kulife)){
        $abt_title = $kulife['0']['title'];
        $message = $kulife['0']['description'];
    if(!empty($kulife['0']['cover_photo'])){

$cover_photo = '<div class="vc_single_image-wrapper   vc_box_border_grey"><img  src="'.base_url().'uploads/'.$kulife['0']['cover_photo'].'" class="img-responsive vc_single_image-img attachment-full"/></div>';
    }else{
         

 $cover_photo =  '<div class="vc_single_image-wrapper   vc_box_border_grey"><img  src="'.base_url().'uploads/initial-images/natural.jpg" class="img-responsive vc_single_image-img attachment-full"/></div>';
    }        
    }else{
        $abt_title ='';
        $message ='';
    ...
    if(!empty($banner)){
        if($banner['7']['banner_of']==='studentlife'){
            $b = base_url().'uploads/banner/'.$banner['7']['banner_name'];
        }
    }
?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="text-left col-md-8">
                            <h2 class="page-leading">Student Life</h2>
