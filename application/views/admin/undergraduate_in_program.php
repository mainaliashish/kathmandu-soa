...
$proId = $undrgdr_pro['0']['id'];
$program = $undrgdr_pro['0']['program'];
$level = $undrgdr_pro['0']['level'];
$overview = $undrgdr_pro['0']['overview'];
$bachelor_program_at_KU = $undrgdr_pro['0']['bachelor_program_at_KU'];
$bachelor_program_goals = $undrgdr_pro['0']['bachelor_program_goals'];
$bachelor_fees_and_funding = $undrgdr_pro['0']['bachelor_fees_and_funding'];
$how_to_apply_for_bachelor= $undrgdr_pro['0']['how_to_apply_for_bachelor'];
$under_gdr = $level.' in '.$program;
if(!empty($undrgdr_pro['0']['course_brochure'])){
