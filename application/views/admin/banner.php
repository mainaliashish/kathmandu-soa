    ...
    echo '';
				...
				<div class="col-md-offset-1 col-md-10 well">
					<div class="panel-header">
						<h3>Change Banner---KUSOA</h3>
					</div>
					<div class="panel-body">

						<?php echo form_open_multipart('Admin/updatebanner');?><div class="row">
							<div class="col-md-6">
...
<div class="col-md-6">
	...
	<option selected disabled hidden>Select Banner You want to Change..</option>
		<option value="1">About us</option>
		<option value="2">Message form Dean</option>
		<option value="3">Collaboration</option>
		<option value="4">Graduation</option>
		<option value="5">Undergraduation</option>
		<option value="6">Announcement</option>
		<option value="7">News</option>
		<option value="8">Student life</option>
